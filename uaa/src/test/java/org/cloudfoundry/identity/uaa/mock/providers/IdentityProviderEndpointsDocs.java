...
public class IdentityProviderEndpointsDocs extends InjectedMockContextTest {
    ...
    private static final Snippet commonRequestParams = requestParameters(parameterWithName("rawConfig").optional("false").type(BOOLEAN).description("<small class=\"deprecated\">Deprecated in 3.14</small> Flag indicating whether the response should use raw, unescaped JSON for the `config` field of the IDP, rather than the default behavior of encoding the JSON as a string."));
